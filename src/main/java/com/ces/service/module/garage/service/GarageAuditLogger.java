...
/** Writes Qaraj actions to the shared, generic {@link AuditLog} table (module = {@code GARAGE}). */
@Component
public class GarageAuditLogger {
    ...
    public GarageAuditLogger(AuditLogRepository auditLogRepository) {
